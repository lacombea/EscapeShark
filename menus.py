...
class Menu4(Page):
	...
	def __init__(self, parent, controller):
		...
		Label2 = tk.Label(frame, font=("Courier",12), wraplength = 700, text = "Lors de ce jeu intercatif, vous allez devoir résoudre différentes énigmes sur le thème des requins afin de pouvoir progresser. Vous allez devoir utiliser votre matière grise, si vous en avez... mais attention, vous devez faire vite !\n")
		Label2.pack()
